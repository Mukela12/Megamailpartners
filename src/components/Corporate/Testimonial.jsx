...
//= Data
import data from '@/data/Corporate/testimonials.json';
      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-5 valign">
            <div className="cont">
              <div>
                <h6 className="sub-title mb-15">Since 2014</h6>
                <h3>We have been creating business saving Email Campaigns</h3>
                <div className="stauts d-flex mt-20">
                  <div className="item d-flex align-items-center mt-30">
                    <h2 className="mr-20">700</h2>
                    <p className="fz-14">Happy Business <br /> Owners Around World</p>
                  </div>
                </div>
              </div>
            </div>

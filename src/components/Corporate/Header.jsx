                    ...
                    <div className="row justify-content-center">
                      <div className="col-lg-10">
                        <div className="caption text-center">
                          ...
                          <h1 > <span className="fz-60">Your Email List Should Be Your</span> <span className="stroke fw-700 opacity-7" style={{color: '#C29125'}}>#1</span>  <span className="fz-60"> </span>Salesperson We'll Show You How</h1>

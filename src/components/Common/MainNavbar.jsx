      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
            <Link className="nav-link" href={`/${lightMode ? 'light' : 'dark'}/page-about`}><span className="rolling-text">About</span></Link>
            </li>

            <li className="nav-item">
            <Link className="nav-link" href={`/${lightMode ? 'light' : 'dark'}/page-services`}><span className="rolling-text">Services</span></Link>
            </li>

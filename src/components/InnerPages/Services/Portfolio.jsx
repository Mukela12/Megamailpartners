                    ...
                    <div className="col-md-11">
                      ...
                      <ul className="rest list-arrow mt-30">
                        <li>
                          ...
                          <h6 className="inline fz-16 fw-400">{item.point1}</h6>
                        </li>
                        <li className="mt-5">
                          <span className="icon">
                          ...
                          <h6 className="inline fz-16 fw-400">{item.point2}</h6>
                        </li>
                        <li className="mt-5">
                          <span className="icon">
                            <svg width="100%" height="100%" viewBox="0 0 9 8" fill="none"
                          ...
                          <h6 className="inline fz-16 fw-400">{item.point3}</h6>
                        </li>
                      </ul>
                      <a href="https://megamail.scoreapp.com/" className="butn-circle d-flex align-items-center text-center mt-50">
                        <div className="full-width">
                          ...
                          <span className="full-width">Free analysis</span>
                        </div>
